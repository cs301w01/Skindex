...
public abstract class GalleryData implements Serializable {
	...
	/**
	 * Invokes the DBManager to return a set of Picture objects based on the
	 * type of gallery
	 * 
	...
	/**
	 * By default, a Gallery is not an album. But if the given gallery is an
	 * album, it should override this function and return true
	 * 
